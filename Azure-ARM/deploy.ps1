...
$subscriptionId = "88ec0691-d883-480d-827f-1f043c951974" #insert your subscription ID
$resourceGroupName = "anish-app-grp"  #provide resource group name
$resourceGroupLocation = "East US"  #location

# The below  file can be used if the templates are stored locally 
$templateFilePath = "E:\Azure\AzureARM\AzureARM\Azure-ARM\ARM-Templates\template.json"
$parametersFilePath = "E:\Azure\AzureARM\AzureARM\Azure-ARM\ARM-Templates\paramters.json"
